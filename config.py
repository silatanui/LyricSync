...
class Config:
    ...
    # Cookie flags - enable in production once served over HTTPS (e.g. tanuisila.dev)
    ...
    # Database - defaults to the local XAMPP/MySQL instance (manage via phpMyAdmin)
    ...
    # Google OAuth (Sign in with Google) - create credentials at console.cloud.google.com
